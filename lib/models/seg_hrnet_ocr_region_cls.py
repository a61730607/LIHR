...
class HighResolutionNet(nn.Module):
    ...
    def forward(self, x):
        ...
        feats = torch.cat([x[0], x1, x2, x3], 1)  # N *720*128*256
        
        cls_patch = self.patch_head(feats)
        # print('cls_patch', cls_patch.shape)
        out_aux_seg = []
